...
opcode_descriptions =
	...
	"Load the constant number Bx into register R(A).", 
    ...
    "Read the upvalue indexed as B into register R(A).",  
    "Read the value of the global variable named as the constant number Bx into register R(A).", 
    "Read the table element R(B)[RK(C)] into register R(A).",  
    "Write the register value R(A) into the global variable named as the constant number Bx.",
    "Write the register value R(A) into the upvalue indexed as B.",
    ...
    "Iterate a generic for loop. R(A) holds the iterator function (called once per loop).\n\t\t\tR(A+1) holds the state.\n\t\t\tR(A+2) holds the enumeration index.", 
